...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 922385821161799230),
      name: 'TodoModel',
      lastPropertyId: const IdUid(4, 2340430361002460935),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 1556725015857290547),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 1463779133434014070),
            name: 'tittle',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 7656692233022388017),
            name: 'body',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2340430361002460935),
            name: 'date',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 922385821161799230),
  ...
  final bindings = <Type, EntityDefinition>{
    TodoModel: EntityDefinition<TodoModel>(
        ...
        objectToFB: (TodoModel object, fb.Builder fbb) {
          final tittleOffset = fbb.writeString(object.tittle);
          final bodyOffset = fbb.writeString(object.body);
          final dateOffset = fbb.writeString(object.date);
          fbb.startTable(5);
          fbb.addInt64(0, object.id ?? 0);
          fbb.addOffset(1, tittleOffset);
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = TodoModel(
              tittle: const fb.StringReader(asciiOptimization: true)
